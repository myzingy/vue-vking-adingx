...
<template>
    <div class="keyword-ac">
        <el-table :data="rulesLog" border style="width: 100%" max-height="300"
                  @sort-change="sortChange">
            <el-table-column columnKey="ad_id" prop="ad_id"
                             label="Ad ID"
                             width="160">
            </el-table-column>
            <!--
    ...
    export default {
        ...
        methods:{
            getData(){
                ...
                formSearch.request='AD';
                formSearch.keyword_acid=this.scope.row.account_id;
