...
ALTER TABLE `facebook_ads`.`ads_insights` CHANGE `ad_name` `ad_name` VARCHAR(250) CHARSET utf8mb4 COLLATE utf8mb4_general_ci NULL, CHANGE `adset_name` `adset_name` VARCHAR(250) CHARSET utf8mb4 COLLATE utf8mb4_general_ci NULL, CHANGE `campaign_name` `campaign_name` VARCHAR(250) CHARSET utf8mb4 COLLATE utf8mb4_general_ci NULL;