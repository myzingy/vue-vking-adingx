...
ALTER TABLE `facebook_ads`.`accounts_insights` CHANGE `country_spend` `country_cost` VARCHAR(500) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '[]' NULL, ADD COLUMN `country_purchase` VARCHAR(500) DEFAULT '[]' NULL AFTER `country_cost`, ADD COLUMN `country_income` VARCHAR(500) DEFAULT '[]' NULL AFTER `country_purchase`, ADD COLUMN `country_addtocart` VARCHAR(500) DEFAULT '[]' NULL AFTER `country_income`, ADD COLUMN `country_cpm` VARCHAR(500) DEFAULT '[]' NULL AFTER `country_addtocart`, ADD COLUMN `country_ctr` VARCHAR(500) DEFAULT '[]' NULL AFTER `country_cpm`, ADD COLUMN `country_link_click` VARCHAR(500) DEFAULT '[]' NULL AFTER `country_ctr`; 
